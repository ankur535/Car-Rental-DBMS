...
public Statement st;
    ...
    public car_page2() {
        ...
        ImageIcon myimage = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("ks.jpg")));
        Image img1 = myimage.getImage();
        Image img2 = img1.getScaledInstance(jLabel2.getWidth(),jLabel2.getHeight(),Image.SCALE_SMOOTH);
        ImageIcon i = new ImageIcon(img2);
        jLabel2.setIcon(i);
        
        ImageIcon myimage1= new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("mx.jpg")));
        ...
        ImageIcon myimage2 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("bx.jpeg")));
        ...
        ImageIcon myimage3 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("nm1.jpg")));
        ...
        try{
            String sql = "Select * from car where car_id = 141 and loc_id =202";
        ...
        try{
            String sql1 = "Select * from car where car_id = 142 and loc_id =202";
         ...
         try{
            String sql2 = "Select * from car where car_id = 143 and loc_id =202";
          ...
          try{
            String sql3 = "Select * from car where car_id = 144 and loc_id =202";
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Banashankari");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(540, 30, 330, 80);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(520, 160, 50, 30);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jLabel8);
        jLabel8.setBounds(550, 160, 70, 30);
        ...
        jLabel28.setBounds(1550, 180, 90, 30);

        jLabel29.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel29.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jLabel29);
        jLabel29.setBounds(1590, 180, 120, 30);
        ...
        jLabel37.setBounds(1090, 600, 430, 290);
        ...
        jLabel34.setBounds(1540, 620, 80, 30);
        ...
        jLabel25.setBounds(540, 600, 80, 30);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(1, 0, 1920, 1090);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        String q1 = "Select availability from car where car_id = 141";
        try {
            ...
            if(rs1.next())
            {
                ...
                if(avail>0)
                {
                    Book_page fp = new Book_page(141);
        fp.setVisible(true);
        fp.pack();
        fp.setLocationRelativeTo(null);
        fp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        String q1 = "Select availability from car where car_id = 142";
        try {
            ResultSet rs1 = st.executeQuery(q1);
            if(rs1.next())
            {
                ...
                if(avail>0)
                {
                    Book_page fp = new Book_page(142);
        fp.setVisible(true);
        fp.pack();
        fp.setLocationRelativeTo(null);
        fp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        String q1 = "Select availability from car where car_id = 144";
        try {
            ResultSet rs1 = st.executeQuery(q1);
            if(rs1.next())
            {
                ...
                if(avail>0)
                {
                    Book_page fp = new Book_page(144);
        fp.setVisible(true);
        fp.pack();
        fp.setLocationRelativeTo(null);
        fp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        String q1 = "Select availability from car where car_id = 143";
        try {
            ResultSet rs1 = st.executeQuery(q1);
            if(rs1.next())
            {
                ...
                if(avail>0)
                {
                    Book_page fp = new Book_page(143);
        fp.setVisible(true);
        fp.pack();
        fp.setLocationRelativeTo(null);
        fp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(car_page2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
