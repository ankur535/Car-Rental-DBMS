...
public Statement st;
    ...
    public car_page1() {
        ...
        ImageIcon myimage = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("hv.jpg")));
        Image img1 = myimage.getImage();
        Image img2 = img1.getScaledInstance(jLabel2.getWidth(),jLabel2.getHeight(),Image.SCALE_SMOOTH);
        ImageIcon i = new ImageIcon(img2);
        jLabel2.setIcon(i);
        
        ImageIcon myimage1= new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("amr.jpg")));
        ...
        ImageIcon myimage2 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("vx.jpg")));
        ...
        ImageIcon myimage3 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("aq.jpg")));
        ...
        try{
            String sql = "Select * from car where car_id = 121 and loc_id =201";
            ...
            if(rs.next())
            {
                 ...
                 String j9 = rs.getString("mileage");
                 String j10 = rs.getString("reg_no");
                 String j11= rs.getString("cat_name");
                 
                 jLabel7.setText(j7);
                 jLabel8.setText(j8);
                 jLabel9.setText(j9+" Km/L");
                 jLabel10.setText(j10);
        ...
        try{
            String sql1 = "Select * from car where car_id = 122 and loc_id =201";
         ...
         try{
            String sql2 = "Select * from car where car_id = 123 and loc_id =201";
          ...
          try{
            String sql3 = "Select * from car where car_id = 124 and loc_id =201";
    ...
    private void initComponents() {
        ...
        jLabel6.setText("IndiraNagar");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(530, 20, 240, 80);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(70, 150, 430, 290);

        jLabel20.setText("jLabel2");
        jPanel1.add(jLabel20);
        jLabel20.setBounds(1080, 150, 430, 290);
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(590, 160, 120, 30);

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jLabel11);
        jLabel11.setBounds(520, 360, 180, 30);
        ...
        jLabel29.setBounds(1660, 180, 120, 30);
        ...
        jLabel37.setBounds(1080, 600, 430, 290);
        ...
        jLabel35.setBounds(1590, 620, 120, 30);
        ...
        jLabel24.setBounds(600, 600, 120, 30);
        ...
        jLabel22.setBounds(540, 800, 180, 30);
        ...
        jButton2.setBounds(250, 470, 110, 40);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\ankur\\OneDrive\\Pictures\\Project\\simple-gray-abstract-background-wi-1920x1080.jpg")); // NOI18N
        jPanel1.add(jLabel3);
        jLabel3.setBounds(0, -4, 1920, 1090);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        String q1 = "Select availability from car where car_id = 121";
        try {
            ...
            if(rs1.next())
            {
                ...
                if(avail>0)
                {
                    Book_page fp = new Book_page(121);
        fp.setVisible(true);
        fp.pack();
        fp.setLocationRelativeTo(null);
        fp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
       String q1 = "Select availability from car where car_id = 122";
        try {
            ResultSet rs1 = st.executeQuery(q1);
            if(rs1.next())
            {
                ...
                if(avail>0)
                {
                    Book_page fp = new Book_page(122);
        fp.setVisible(true);
        fp.pack();
        fp.setLocationRelativeTo(null);
        fp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        String q1 = "Select availability from car where car_id = 124";
        try {
            ResultSet rs1 = st.executeQuery(q1);
            if(rs1.next())
            {
                ...
                if(avail>0)
                {
                    Book_page fp = new Book_page(124);
        fp.setVisible(true);
        fp.pack();
        fp.setLocationRelativeTo(null);
        fp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
     String q1 = "Select availability from car where car_id = 123";
        try {
            ResultSet rs1 = st.executeQuery(q1);
            if(rs1.next())
            {
                ...
                if(avail>0)
                {
                    Book_page fp = new Book_page(123);
        fp.setVisible(true);
        fp.pack();
        fp.setLocationRelativeTo(null);
        fp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(car_page1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
